		...
		<div class="attr" :style='{"minHeight":"680px","padding":"20px","position":"relative","flexDirection":"row-reverse","display":"flex"}'>
			...
			<div class="info" :style='{"width":"640px","padding":"10px","margin":"0 20px 0 0","background":"rgba(245, 245, 245, 1)"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"122px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>用户名</div>
					<div  :style='{"padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","color":"#666","background":"#fff","width":"400px","fontSize":"14px","lineHeight":"40px"}'>{{detail.username}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"122px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>角色</div>
					<div  :style='{"padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","color":"#666","background":"#fff","width":"400px","fontSize":"14px","lineHeight":"40px"}'>{{detail.role}}</div>
				</div>
