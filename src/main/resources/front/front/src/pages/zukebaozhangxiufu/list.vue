...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"20px","overflow":"hidden","borderRadius":"20px","flexWrap":"wrap","background":"#c6e8d4","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"margin":"5px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>订单编号</div>
        <el-input v-model="formSearch.dingdanbianhao" placeholder="订单编号" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"5px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>报修名称</div>
        <el-input v-model="formSearch.baoxiumingcheng" placeholder="报修名称" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('zukebaozhangxiufu','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#000","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/zukebaozhangxiufuAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.dingdanbianhao != '') searchWhere.dingdanbianhao = '%' + this.formSearch.dingdanbianhao + '%';
        if (this.formSearch.baoxiumingcheng != '') searchWhere.baoxiumingcheng = '%' + this.formSearch.baoxiumingcheng + '%';
	      params['sfsh'] = '是';
        this.$http.get('zukebaozhangxiufu/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/zukebaozhangxiufuDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
