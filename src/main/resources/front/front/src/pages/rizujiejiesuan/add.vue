...
<div :style='{"width":"1000px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"0 auto 20px","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="日租金" prop="rizujin">
            <el-input v-model="ruleForm.rizujin" 
                placeholder="日租金" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="租借时长(天)" prop="rizujieshizhang">
            <el-input v-model="ruleForm.rizujieshizhang" 
                placeholder="租借时长(天)" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="剩余金额" prop="shengyujine">
  ...
  export default {
    ...
    computed: {
        ...
        shengyujine:{
            ...
            get: function () {
                return 1*this.ruleForm.rizujin*this.ruleForm.rizujieshizhang-parseFloat(this.ruleForm.dingjin==""?0:this.ruleForm.dingjin)
            }
        },
    },
    components: {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='rizujieshizhang'){
              this.ruleForm.rizujieshizhang = obj[o];
              this.ro.rizujieshizhang = true;
              continue;
            }
            if(o=='dingjin'){
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('rizujiejiesuan/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('rizujiejiesuan/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('rizujiejiesuan/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
