<template>
	<div class="main-containers">
		<div class="top-container" :style='{"boxShadow":"0 1px 6px rgba(64, 158, 255, .3)","padding":"0 20px","alignItems":"center","backgroundImage":"url(http://codegen.caihongy.cn/20220913/4f6347664aba4954887a09bdb77a0ea2.png)","display":"flex","justifyContent":"space-between","overflow":"hidden","top":"0","left":"0","width":"100%","backgroundSize":"100% 100%","position":"fixed","height":"64px","zIndex":"1002"}'>
			...
			<div v-if="true" :style='{"color":"rgba(255, 255, 255, 1)","fontSize":"22px"}'>基于SpringBoot框架的服装租借管理系统</div>
			<div>
				<div v-if="false" :style='{"color":"#666","fontSize":"14px","display":"inline-block"}'></div>
		...
		<div class="body-containers" :style='"horizontal" == "vertical" ? {"minHeight":"100vh","padding":"64px 0 0","margin":"0 0 0 210px","position":"relative","background":"rgba(64, 158, 255, .3)","display":"block"} : {"minHeight":"100vh","padding":"65px 0 0","margin":"0","position":"relative"}'>
			<div class="menu-preview" :style='{"minHeight":"130px","width":"100%","padding":"30px 160px 0","margin":"-10px 0 0 0","backgroundSize":"100% 100%","backgroundImage":"url(http://codegen.caihongy.cn/20220913/fd12666b4f5848f481cd9a230e87cd3e.png)"}'>
				<el-menu class="el-menu-horizontal-demo" :style='{"border":0,"padding":"0","listStyle":"none","background":"#FFF","display":"flex","position":"relative","justifyContent":"center"}' :default-active="activeIndex" :unique-opened="true" mode="horizontal" :router="true" @select="handleSelect">
			...
			<div class="bottom-preview" :style='{"padding":"20px 0","alignItems":"center","background":"#000","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center"}'>
...
<style rel="stylesheet/scss" lang="scss" scoped>
	...
	.menu-preview .el-menu-horizontal-demo .el-menu-item {
		...
		line-height: 40px;
		align-items: center;
		background-image: url(http://codegen.caihongy.cn/20220913/5b960258e2354c70a19c7739a29f53c3.png);
		position: relative;
		list-style: none;
		min-width: 100px;
		height: 40px;
	...
	.menu-preview .el-menu-horizontal-demo .el-menu-item.is-active {
		...
		line-height: 40px;
		background-color: #fff;
		background-image: url(http://codegen.caihongy.cn/20220913/2ee9a914ab4a4118b1a92a9c7d3b3a7b.png);
		position: relative;
		list-style: none;
		height: 40px;
	}
