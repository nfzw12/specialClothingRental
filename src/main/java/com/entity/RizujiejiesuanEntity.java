...
public class RizujiejiesuanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public RizujiejiesuanEntity() {
		
	}
	
	public RizujiejiesuanEntity(T t) {
		try {
	...
	private String rizujieshizhang;
	 ...
	 * 设置：租借时长(天)
	 */
	public void setRizujieshizhang(String rizujieshizhang) {
		this.rizujieshizhang = rizujieshizhang;
	}
	/**
	 * 获取：租借时长(天)
	 */
	public String getRizujieshizhang() {
		return rizujieshizhang;
	}
	/**
	 * 设置：订金
	 */
	 ...
	 * 设置：剩余金额
	 */
	public void setShengyujine(Integer shengyujine) {
		this.shengyujine = shengyujine;
	}
	/**
	 * 获取：剩余金额
	 */
	public Integer getShengyujine() {
		return shengyujine;
	}
	/**
	 * 设置：收租日期
