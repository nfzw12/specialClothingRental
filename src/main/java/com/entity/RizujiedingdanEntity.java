...
public class RizujiedingdanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public RizujiedingdanEntity() {
		
	}
	
	public RizujiedingdanEntity(T t) {
		try {
	 ...
	 * 设置：租借时长
	 */
	public void setZujieshizhang(String zujieshizhang) {
		this.zujieshizhang = zujieshizhang;
	}
	/**
	 * 获取：租借时长
	 */
	public String getZujieshizhang() {
		return zujieshizhang;
	}
	/**
	 * 设置：订金
	 */
