...
public class YuezujiejiesuanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YuezujiejiesuanEntity() {
		
	}
	
	public YuezujiejiesuanEntity(T t) {
		try {
	...
	private Integer shengyufeiyong;
	 ...
	 * 设置：剩余费用
	 */
	public void setShengyufeiyong(Integer shengyufeiyong) {
		this.shengyufeiyong = shengyufeiyong;
	}
	/**
	 * 获取：剩余费用
	 */
	public Integer getShengyufeiyong() {
		return shengyufeiyong;
	}
	/**
	 * 设置：租借日期
	 */
